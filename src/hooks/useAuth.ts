...
const ACCOUNT_SCOPED_KEYS = [PROFILE_STORAGE_KEY, MEDICINE_STORAGE_KEY, INTAKE_LOG_STORAGE_KEY, CAREGIVER_STORAGE_KEY, CAREGIVER_TRANSACTION_STORAGE_KEY, RESOURCE_LOG_STORAGE_KEY, QUICK_TAP_STORAGE_KEY];
